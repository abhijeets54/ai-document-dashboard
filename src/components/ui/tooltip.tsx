      ...
      <AnimatePresence>
        {isVisible && (
          <motion.div
            ...
            className={cn(
              'absolute z-50 px-2 py-1 text-xs font-medium text-white bg-gray-900 rounded shadow-lg pointer-events-none whitespace-nowrap dark:bg-gray-100 dark:text-gray-900',
